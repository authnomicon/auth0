...
var factory = require('../../../app/guardian/browserish/credential');


describe.skip('auth0/client/browserish/credential', function() {
  ...
  describe('getCredential', function() {
    ...
    describe('obtaining a token', function() {
      ...
      before(function(done) {
        var factory = $require('../../../app/guardian/browserish/credential', { 'auth0-guardian-js': guardian });
